...
// ../src/main/resources/.../webjars/prov/vue/index.js is what the host
// loads at runtime — here we test the authoring surface directly.
import pluginProvDef, { service as provService } from '../index.js'
...
describe('plugin-prov via callFeature()', () => {
  beforeEach(() => { pluginRegistry.register('prov', pluginProvDef) })
  afterEach(() => { pluginRegistry.remove('prov') })
