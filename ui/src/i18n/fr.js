...
export default {
  ...
  'prov.quote.network.help': 'Les liens entrants viennent d\'une autre ressource de ce devis vers {name} ; les liens sortants vont de {name} vers une autre ressource. Le port est obligatoire.',
  ...
  'prov.quote.network.rate': 'Débit',
  'prov.quote.network.throughput': 'Volume (Ko/s)',
  'prov.quote.network.noPeer': 'Choisir une ressource',
  'prov.quote.network.empty': 'Aucun lien',
  'prov.quote.network.add': 'Ajouter un lien',
  'prov.quote.network.invalid': 'Chaque lien nécessite une ressource et un port entre 1 et 65535.',
}
