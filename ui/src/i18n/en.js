...
export default {
  ...
  'prov.quote.network.help': 'Inbound links come from another resource of this quote to {name}; outbound links go from {name} to another resource. The port is required.',
  ...
  'prov.quote.network.rate': 'Rate',
  'prov.quote.network.throughput': 'Throughput (KB/s)',
  'prov.quote.network.noPeer': 'Select a resource',
  'prov.quote.network.empty': 'No link',
  'prov.quote.network.add': 'Add a link',
  'prov.quote.network.invalid': 'Each link needs a resource and a port between 1 and 65535.',
}
