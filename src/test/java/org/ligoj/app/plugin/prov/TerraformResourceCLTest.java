...
public class TerraformResourceCLTest {
	...
	@Test
	public void newBuildWindows() throws IOException, ReflectiveOperationException {
		checkCommands("Windows", new String[] { "cmd.exe", "/c", "terraform" });
	}

	@Test
	public void newBuildOther() throws IOException, ReflectiveOperationException {
	...
	private void checkCommands(final String os, final String... command)
		...
		try {
			...
			Assert.assertEquals(command, ((Class<TerraformResource>) urlClassLoader.loadClass(TerraformResource.class.getName()))
