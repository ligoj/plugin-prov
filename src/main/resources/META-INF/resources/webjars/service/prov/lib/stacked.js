    ...
    return (function () {
        ...
        function initialize() {
            ...
            legend.append("svg:foreignObject")
                ...
                .attr('width', 18)
                .style('color','white')
                .html(d => `<i id="inner_icone" class="${d === 'instance' ? "fas fa-server fa-fw" : d === 'database' ? "fa fa-database fa-fw" : d === 'container' ? "fab fa-docker fa-fw" : d === 'storage' ? "far fa-hdd fa-fw" :"fas fa-ambulance fa-fw"}" data-toggle="tooltip" title="${d}"></i>`);
