    ...
    return (function () {
        ...
        function initializeLegend(svg, margin, chosen) {
            ...
            legend.append("svg:foreignObject")
                ...
                .attr('width', 18)
                .style('color', 'white')
                .html(d => `<i class="${d === 'instance' ? "fas fa-server fa-fw" : d === 'database' ? "fa fa-database fa-fw" : d === 'container' ? "fab fa-docker fa-fw" : d === 'storage' ? "far fa-hdd fa-fw" : d === 'function' ? "fas fa-code" : "fas fa-ambulance fa-fw"}" data-toggle="tooltip" data-placement="left" title="${d.capitalize()}"></i>`);
        }
