define({
    'root': {
        ...
        'service:prov:terraform:status-clean': 'Cleaning Terraform resources',
        'service:prov:terraform:status-state': 'Analysing the Terraform state',
        'service:prov:terraform:status-show': 'Analysing the Terraform changes',
        'service:prov:terraform:status-secrets': 'Generating Terraform secrets',
