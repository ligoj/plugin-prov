...
define({
    'root': {
        ...
        'service:prov:architecture-default': 'Any',
        'service:prov:architecture-help': 'Required processor\'s architecture. Only instance type matching to this architecture will be used.<br>Case is insensitive.',
        'service:prov:architecture-failed': 'Architecture {{this}} makes some instances unavailable',
        ...
        'service:prov:optimizer-null': 'Cheapest',
        'service:prov:optimizer-help': 'Chosen optimizer will infer the term, and the best cost or CO2. Available optimizers are at the subscription level. When undefined, the default optimizer is used. When there is no default optimizer, the cost is priority',
        ...
        'service:prov:optimizer-mode-help': 'With this mode, the priority is the CO2 over the cost.',
        'service:prov:optimizer-p1TypeOnly': 'Lookup strategy',
        'service:prov:optimizer-p1TypeOnly-true': 'Most efficient',
        'service:prov:optimizer-p1TypeOnly-false': 'Cheapest',
        'service:prov:optimizer-p1TypeOnly-help': 'With this mode, the priority is still the price but among the most recent processors SKUs',
