...
define({
    'root': {
        ...
        'service:prov:database-vendor': 'Vendor',
        'service:prov:database-vendor-title': 'Database vendor: MySQL,...',
        ...
        'service:prov:usage-duration-help': 'Estimated commited duration for this usage. Depending on this value the best term is determined.',
