define({
    'root': {
        ...
        'service:prov:instance-max-cost': 'Max cost',
        'service:prov:instance-max-cost-title': 'Maximum cost this instance would be valid',
        'service:prov:instance-max-cost-help': 'Optional maximum cost this instance would be valid. When undefined, there is no limit. When the threshold is reached the instance would be terminated.',
