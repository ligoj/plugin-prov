...
define({
    'root': {
        ...
        'quote-reservation-mode': 'Lookup mode based on observed or reserved CPU/RAM values',
        'quote-processor': 'Required processor type. Only instance type matching to this type will be used. Vendor name are also accepted: "Intel", "AMD",...<br>Case is insensitive, and a contains is used for the match.',
        ...
        'service:prov:software-title': 'Pre-installed sofware',
