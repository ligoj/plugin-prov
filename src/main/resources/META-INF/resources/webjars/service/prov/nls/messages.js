define({
    'root': {
        ...
        'service:prov:terraform:status-apply-completed': 'Terraform <strong>apply</strong>: {{[0]}}/{{[1]}} completed changes',
        'service:prov:terraform:status-apply-completing': 'Terraform <strong>apply</strong>: completing {{this}} changes',
