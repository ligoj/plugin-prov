define({
    'root': {
        ...
        'service:prov:terraform:status-init': '"init" phase', 
        'service:prov:terraform:status-plan': '"plan" phase', 
        'service:prov:terraform:status-apply-completed': '"apply" {{[0]}}/{{[1]}} handled resources',
        'service:prov:terraform:status-apply-completing': '"apply" {{[0]}} being handled resources',
