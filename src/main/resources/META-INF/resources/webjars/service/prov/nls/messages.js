...
define({
    'root': {
        ...
        'service:prov:support-mail': 'Mail',
        'service:prov:support-mail-title': 'Mail access type',
        'service:prov:support-mail-help': 'Who need to access to support using e-mail',
