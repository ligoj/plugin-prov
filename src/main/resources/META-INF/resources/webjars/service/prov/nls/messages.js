...
define({
    'root': {
        ...
        'service:prov:optimizer-help': 'Chosen optimizer will infer the term, and the best cost or CO2. Available optimizers are at the subscription level. When undefined, the default optimizer is used. And when there is no default optimizer, it will be cost.',
