...
define({
	...
	'quote-license': 'Modalité de licence applicable sur des OS, pour le moment WINDOWS uniquement.',
	...
	'quote-reservation-mode': 'Mode de recherche basé sur les valeurs maximales ou réservées de CPU/RAM',
	'quote-processor': 'Type de processeur requis. Seuls les types d\'instance correspondanr seront utilisés: "Intel", "AMD",...<br>Non sensible à la casse et un "contient" est utiilisé pour la correspondance.',
    ...
    'service:prov:cpu-title': 'Coeurs requis. Peut ne pas correspondre à un CPU physique',
	...
	'service:prov:license-help': 'Si indéfinie, le mode de licence par défaut est utilisé.<br>L\'OS et les licences logicielles sont incluses dans la prix pour l\'option "Incluse"',
	...
	'service:prov:storage-quantity-title': 'Nombre de volumes. Lorsque liés à des instances, correspond au nombre d\instances associées.',
	...
	'service:prov:storage-instance-title': 'Instance ou base de donnée ce stockage est attaché. Sera supprimée lorsque cette instance le sera, même si leur cycle de vie sont indépendants à l\'exécution',
	...
	'service:prov:support-title': 'Supports activés',
