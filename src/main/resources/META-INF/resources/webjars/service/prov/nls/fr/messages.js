define({
    ...
    'service:prov:instance-max-cost': 'Coût max',
    'service:prov:instance-max-cost-title': 'Coût maximum où cette instance sera valide',
    'service:prov:instance-max-cost-help': 'Coût maximum optionnel où cette instance sera valide. Lorsque non définie, il n\'y a pas de liite. Lorsque ce seuil est atteint, l\'instance serait supprimée.',
