...
define({
    ...
    'service:prov:architecture': 'Architecture',
    'service:prov:architecture-default': 'Tous',
    'service:prov:architecture-help': 'Architecture de processeur requise. Seuls les types d\'instance correspondants seront utilisés.<br>Non sensible à la casse.',
    'service:prov:architecture-failed': 'L\'architecture {{this}} rend certaines instances incompatibles',
	'service:prov:processor': 'Processeur',
	'service:prov:processor-default': 'Tous',
	'service:prov:processor-help': 'Type de processeur ou generation requis. Seuls les types d\'instance correspondants seront utilisés: "Intel", "AMD",...<br>Non sensible à la casse et un "contient" est utilisé pour la correspondance.<br>Pour la contrainte de génération, seuls les derniers processeurs disponibles seront éligibles.',
    ...
    'service:prov:optimizer-null': 'Moins cher',
	...
	'service:prov:optimizer-mode-help': 'Avec ce mode, la priorité de recherche est l\'empreinte CO2 ',
    'service:prov:optimizer-p1TypeOnly': 'Stratégie de recherche',
    'service:prov:optimizer-p1TypeOnly-true': 'Plus efficient',
    'service:prov:optimizer-p1TypeOnly-false': 'Moins cher',
    'service:prov:optimizer-p1TypeOnly-help': 'Avec ce mode, la priorité de recherche reste le prix, mais parmi les SKUs de dernière génération',
