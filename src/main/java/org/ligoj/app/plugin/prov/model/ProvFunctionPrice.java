 ...
 * <code>nbRequests=1M, duration=1s, ram=1024MB</code>
 * <ul>
 * <li>AWS: max memory = 10,240MiB, min memory = 128MiB, incrementRam=1MiB
 * <ul>
 * <li>Standard: 1M * (costRequests + 1024/1024 * costRam{Duration} * 1s/(1000*3600*24*30,5))</li>
 * <li>Provisioned: 1M * (costRequests + 1024/1024 * costRam{Provisioned Concurrency + Duration} *
 * 1s/(1000*3600*24*30,5)); type = custom type</li>
 * </ul>
 * </li>
 * <li>Azure
 * <ul>
 * <li>Consumption: 1M * (costRequests + 1024/1024 * costRam{Duration} * 1s/(1000*3600*24*30,5)); max memory = 1.5GiB,
 * min memory = 128MiB, incrementRam= 128MiB</li>
...
public class ProvFunctionPrice extends AbstractTermPriceVm<ProvFunctionType> implements Serializable {
